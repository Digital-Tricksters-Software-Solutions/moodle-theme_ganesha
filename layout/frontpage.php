...
$templatecontext = [
    ...
    'weatherlabel' => get_config('theme_ganesha', 'weatherlabel')
        ?: theme_ganesha_get_default_string('weatherlabel_default', '🌈 Sky weather Board'),
    'weathersubtitle' => get_config('theme_ganesha', 'weathersubtitle')
        ?: theme_ganesha_get_default_string('weathersubtitle_default', 'Click to change the sky theme!'),
    'scratchtitle' => get_config('theme_ganesha', 'scratchtitle')
        ?: theme_ganesha_get_default_string('scratchtitle_default', '🎟️ Magic Scratch Card'),
    'scratchsubtitle' => get_config('theme_ganesha', 'scratchsubtitle')
        ?: theme_ganesha_get_default_string(
            'scratchsubtitle_default',
            'Scratch the silver box with your mouse to reveal your sticker!'
        ),
    'scratchresetbtn' => get_config('theme_ganesha', 'scratchresetbtn')
        ?: theme_ganesha_get_default_string('scratchresetbtn_default', 'Reset Ticket'),
    'pettitle' => get_config('theme_ganesha', 'pettitle')
        ?: theme_ganesha_get_default_string('pettitle_default', "Ganesha's Sweet Shop"),
    'petdesc' => get_config('theme_ganesha', 'petdesc')
        ?: theme_ganesha_get_default_string(
            'petdesc_default',
            'Feed baby Ganesha his favorite sweet (Modak) to become best friends!'
        ),
    'petfeedbtn' => get_config('theme_ganesha', 'petfeedbtn')
        ?: theme_ganesha_get_default_string('petfeedbtn_default', '🍬 Feed a Modak!'),
    'petmascot' => $petmascot,
    ...
    'friendshipleveluptext' => theme_ganesha_get_default_string(
        'friendshiplevelup',
